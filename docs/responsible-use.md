...
Hay usos de la IA que comprometen la integridad del trabajo académico, con independencia de lo que digan las políticas formales de la universidad.
...
Cuando usás IA durante el proceso de investigación, lo correcto es declararlo. No existe todavía un estándar único para esto pero el principio es claro: usá la IA abiertamente y describí cómo lo usaste cuando sea relevante. Una nota metodológica al pie o en una sección de agradecimientos es suficiente en la mayoría de los contextos.

Un ejemplo de declaración apropiada:

> Se utilizaron herramientas de inteligencia artificial (Claude, Anthropic) para explorar literatura preliminar e identificar keywords de búsqueda. Todos los trabajos citados fueron verificados y consultados directamente en sus fuentes originales.
