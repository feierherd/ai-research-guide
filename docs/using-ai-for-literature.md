...
## Cómo mapear un campo

**Prompt de ejemplo:**

```
Estoy comenzando una revisión de literatura sobre clientelismo político
en América Latina para mi tesis de grado en ciencia política.

¿Podés ayudarme a:
- identificar los principales debates teóricos en esta literatura,
- mencionar algunos autores influyentes,
...
```
Quiero buscar artículos académicos sobre la relación entre transferencias
sociales y comportamiento electoral en América Latina.

¿Podés sugerirme:
- los términos técnicos más usados en la literatura anglosajona,
- variantes terminológicas que distintas tradiciones de investigación usan,
- autores o debates específicos que convendría incluir en las búsquedas?
```
...
```
Estoy leyendo varios artículos sobre independencia judicial. Los trabajos
que tengo se pueden describir así:

- [breve descripción de trabajo 1]
- [breve descripción de trabajo 2]
- [breve descripción de trabajo 3]

¿Podés sugerir posibles formas de organizar estos trabajos en una revisión
de literatura? Por ejemplo: por enfoque teórico, por estrategia empírica,
...
```
¿Cuál es la diferencia entre las teorías de independencia judicial y las
teorías de accountability judicial? ¿Cómo se relacionan con la noción
de rule of law?

Necesito entender estas distinciones antes de leer la literatura especializada.
```
