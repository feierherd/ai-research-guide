...
## Ejercicio 1 — El abogado del diablo (25 minutos)
...
Escribí en dos o tres oraciones:
- tu pregunta de investigación
- tu argumento central (el mecanismo que propone tu trabajo)
...
- explicá por qué es una amenaza real para mi argumento,
- sugerí qué evidencia distinguiría tu argumento de esta alternativa.
```

### Paso 2 — Evaluación individual (8 minutos)
...
Compartí con un compañero o compañera:
- la alternativa más amenazante que identificaste,
- si tu diseño actual permite distinguir tu argumento de esa alternativa,
- qué cambiarías o agregarías en el trabajo final para abordarla.

---

## Ejercicio 2 — El revisor exigente (25 minutos)
...
Escribí un párrafo (4-6 oraciones) describiendo tu diseño de investigación:
- qué querés medir o evaluar,
- cómo lo vas a hacer (estrategia empírica, método),
...
Actuá como un revisor académico que está evaluando si este diseño
permite responder la pregunta de investigación con validez.

¿Podés identificar:
- posibles problemas de validez interna (¿el diseño permite establecer
  la relación que me interesa o hay confusores que no controlo?),
- posibles problemas de validez externa (¿a qué casos o contextos
  aplican mis conclusiones?),
- problemas de medición (¿las variables que uso capturan los conceptos
  que me interesan?),
- las dos críticas más importantes que un jurado de tesis podría hacerle?
```
...
## Ejercicio 3 — La trampa de las fuentes (15 minutos)

### Objetivo

Descubrir de primera mano el problema de las alucinaciones bibliográficas y establecer un hábito de verificación.

### Paso 1 — Pedí referencias (3 minutos)

Enviá este prompt sobre tu tema:

```
Estoy escribiendo una tesis sobre [tu tema].

¿Podés sugerirme cinco artículos académicos relevantes sobre este tema,
con autor, título, revista y año?
```
