...
La IA puede ayudarte en las tareas que requieren generar opciones — posibles preguntas, posibles mecanismos, posibles diseños, posibles fuentes de datos. La evaluación de esas opciones — cuál pregunta es más interesante, cuál mecanismo es más creíble, cuál diseño es más válido — requiere criterios sustantivos que la IA no tiene.
...
El principio aplica con igual fuerza al uso de la IA en la fase de diseño. Si le pedís al modelo que genere indicadores para medir "independencia judicial" y usás esos indicadores sin evaluar si capturan el concepto que te interesa, tu análisis tendrá probablemente un problema de validez — con independencia de lo refinado que sea el resto del diseño.

La solución no es evitar la IA sino usarlo de manera adecuada: como generador de opciones de medición que vos evaluás contra la teoría y contra el conocimiento sustantivo del caso.

---

## ¿Puede la IA mejorar la ciencia social?
...
Ese último punto merece atención especial. Si le preguntás al AI "¿por qué la independencia judicial reduce la corrupción?", el modelo va a construir un argumento que justifica esa relación — porque la pregunta presupone que la relación existe. Si en cambio preguntás "¿bajo qué condiciones la independencia judicial no reduce la corrupción, y por qué?", obtenés un tipo de respuesta muy diferente. La calidad del razonamiento que la IA produce depende críticamente de la calidad de las preguntas que le hacés.

---

## Síntesis: qué puede y qué no puede hacer la IA en la investigación científica
